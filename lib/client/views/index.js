...
import PortfolioCustomize from './pages/portfolioCustomize';
      ...
      <div className="view-container">
        <Provider store={store}>
          <Router history={history}>
            <Switch>
              <Route exact path="/" component={PortfolioCustomize} />
              <Route path="/customize/:id" component={PortfolioListing} />
